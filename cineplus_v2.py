...
class Ventana4(wx.Frame):
    def __init__(self, parent, informacion="", subtotal1=0, informacion2="", subtotal2=0):
        ...
        #Variables de instanciade la ventana4
        ...
        self.total=self.subtotalTaquilla+self.subtotalTaquilla
        ...
        label_1.SetForegroundColour(wx.Colour(255, 0, 127))
        ...
        label_2.SetForegroundColour(wx.Colour(255, 0, 127))
        ...
        self.lbTaquilla.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Arial Rounded MT Bold"))
        ...
        self.lbSubtotalTaquilla.SetForegroundColour(wx.Colour(255, 255, 255))
        self.lbSubtotalTaquilla.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Arial Rounded MT Bold"))
        sizer_1.Add(self.lbSubtotalTaquilla, 0, 0, 0)

        label_5 = wx.StaticText(self.panel_1, wx.ID_ANY, "DULCERIA")
        label_5.SetForegroundColour(wx.Colour(255, 0, 127))
        ...
        self.lbDulceria.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Arial Rounded MT Bold"))
        ...
        self.lbSubtotalDulceria.SetForegroundColour(wx.Colour(255, 255, 255))
        self.lbSubtotalDulceria.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Arial Rounded MT Bold"))
        sizer_1.Add(self.lbSubtotalDulceria, 0, 0, 0)

        self.lbTotal = wx.StaticText(self.panel_1, wx.ID_ANY, f"Total:${self.total}")
        self.lbTotal.SetForegroundColour(wx.Colour(255, 255, 255))
        self.lbTotal.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Arial Rounded MT Bold"))
...
class Ventana3(wx.Frame):
    def __init__(self, parent, informacion="", subtotal=0, informacion2="", subtotal2=0):
        ...
        super().__init__(parent, style= wx.DEFAULT_FRAME_STYLE)
        #kwds["style"]= wkds.get("style, 0") | wx.DEFAULT_FRAME_STYLE
        #wx.Frame.__init__(self, *ards, **kwds)
        ...
        bitmap_1 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("E:\\cineplus\\dulceria.png", wx.BITMAP_TYPE_ANY))
        ...
        bitmap_3 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("E:\\cineplus\\combo1.png", wx.BITMAP_TYPE_ANY))
        ...
        self.cmbSabor = wx.ComboBox(self.panel_1, wx.ID_ANY, choices=["Coca Cola", "Fanta", "Sprite"], style=wx.CB_DROPDOWN)
        ...
        self.btnLimpiar.SetBitmap(wx.Bitmap("E:\\cineplus\\limpiar.png", wx.BITMAP_TYPE_ANY))
        ...
        self.btnSiguiente.SetBitmap(wx.Bitmap("E:\\cineplus\\siguiente.png", wx.BITMAP_TYPE_ANY))
...
class Ventana1(wx.Frame):
    ...
    def confirmar_usuario_clave(self, event):  # wxGlade: Ventana1.<event_handler>
        ...
        if nombre == "Ixchel" and clave == "123":
